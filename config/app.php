...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | App-Level Maintenance Mode Bypass Secret
    |--------------------------------------------------------------------------
    |
    | Bcrypt hash of the password used to reach /super-admin/login/{password}
    | while the app's custom maintenance-mode flag is enabled. This is
    | independent of Laravel's own "maintenance" config above.
    |
    */
